var descriptionCtrl = function($scope, config, storage, httpService, $stateParams, tips, $state) {
...
angular.module('controllers').controller('doc.docProfile.descriptionCtrl', descriptionCtrl);